...
Descripción:    Ejercicio que muestra la cantidad
                ...
                usuario.
                Modificacion: los positivos a negativos, y los negativos a positivos.
"""
...
while opcion != 0:
    ...
    if opcion > 0:
        ...
        contador1 = 0
        print("Escalones de manera normal: \n")
       ...
       # Se invierte los escalones de la manera solicitada y se aumenta un escalon:
        contador1 = 0
        # Se inicia un contador igualándolo a la cantidad de escalones
        contador_de_espacios = cantidad_de_escalones
        print("Escalones de manera invertida: ")
        while contador1 <= cantidad_de_escalones+1:
    ...
    # Si la cantidad de escalones es negativa
        ...
        contador1 = 0
        # Se inicia un contador igualándolo a la cantidad de escalones
        contador_de_espacios = (cantidad_de_escalones * -1)
        while contador1 <= (cantidad_de_escalones * -1) :
