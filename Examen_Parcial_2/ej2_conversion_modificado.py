...
def suma_de_binarios ():
    ...
    numero1 = input("Ingresa un número en binario: ")
    numero2 = input("Ingresa otro número en binario: ")

    # Conversión a enteros
    for numero in numero1:
        lista_de_binarios1.append(int(numero))
    for numero in numero2:
        lista_de_binarios2.append(int(numero))

    lista_de_binarios1.reverse()
    lista_de_binarios2.reverse()

    # Cantidad de elementos en lista
    cantidad_de_lista = len(lista_de_binarios1)
    # Multiplicación y suma de los valores:
    for iterador in range(0, cantidad_de_lista):
        lista_auxiliar1.append(lista_de_binarios1[iterador] * (2 ** iterador))

    # Cantidad de elementos en lista
    cantidad_de_lista = len(lista_de_binarios2)
    # Multiplicación y suma de los valores:
    for iterador in range(0, cantidad_de_lista):
        lista_auxiliar2.append(lista_de_binarios2[iterador] * (2 ** iterador))


    # Se suman los elementos de la lista
    numero_en_decimal1 = sum(lista_auxiliar1)
    print(f"\nEl primer numero introducido es: {numero_en_decimal1}")
    numero_en_decimal2 = sum(lista_auxiliar2)
    print(f"\nEl segundo numero introducido es: {numero_en_decimal2}")

    resultado_de_suma = numero_en_decimal1 + numero_en_decimal2
    print(f"\nEl resultado de la suma de ambos numero es : {resultado_de_suma}")

    contador = resultado_de_suma
    #####################conversión binario#############################################
    # Ciclo para hacer divisiones
    while contador > 0:
        residuo = contador % 2  # Obtiene el residuo de la división del contador entre 2
    ...
    return  lista_de_cantidad_binaria
...
while opcion != 0:
    ...
    if opcion >= 0 and opcion <= 4:
        if opcion == 0:
            ...
            print(f"\nEl número {numero} en binario es: 0b", end="")
            for elemento in lista1:
                print(elemento, end="")

            print(f"\nEl número {numero} en hexadecimal es: 0x", end="")
            for elemento in lista2:
                print(elemento, end="")
            ...
            # Imprime el contenido de las listas:
            print(f"\nEl número en hexadecimal es: 0x", end="")
            for elemento in lista1:
                print(elemento, end="")
            ...
            # Imprime el contenido de las listas:
            print(f"\nEl número en binario es: 0b", end="")
            for elemento in lista2:
                print(elemento, end="")

        else:
            lista1 = suma_de_binarios()
            print("\nEl resultado de la suma binaria es: ", end="")
            for numero in lista1 :
                print(numero, end="")

            print("\nBinario con el prefijo : 0b", end="")
            for numero in lista1:
                print(numero, end="")
