...
def lenguaje_basico(Diccionario_de_palabras):
    ...
    lista_de_palabras = numeros_en_jenguaje(Diccionario_de_palabras, lista_de_palabras)
...
def numeros_en_jenguaje(Diccionario_de_palabras, lista_de_palabras):
    lista_de_valores_de_numeros = []


    cantidad_de_palabras = len(lista_de_palabras)
    for elemento in range(0,cantidad_de_palabras):
        for llave, valor in Diccionario_de_palabras['numeros'].items():
             if lista_de_palabras[elemento] == llave:
                lista_de_palabras[elemento] =  valor
