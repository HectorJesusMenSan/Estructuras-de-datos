...
def Menu ():
    ...
    print("0) Salir.")
    opcion_del_menu=int(input("ingresa una opcion: "))
...
def Añadir_productos (lista_de_compras):
    ...
    nombre_de_producto_a_agregar, cantidad_de_producto  = input("Ingresa el producto que deceas agregar a la lista: "), input("Ingresa la cantidad: ")
...
def Eliminar_producto (lista_de_compras):
    ...
    casilla_a_eliminar = int(input("Escoqe que producto eliminar: "))
    lista_de_compras.remove(casilla_a_eliminar)
    return lista_de_compras
